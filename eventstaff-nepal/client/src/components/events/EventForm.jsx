    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-xl glass-input text-[color:var(--text-main)] text-[color:var(--text-primary)]"
          placeholder={t(
            ...
            >
              <div className="flex-1">
                <select
                  ...
                  className="w-full px-3 py-2 rounded-xl glass-input text-[color:var(--text-main)] text-[color:var(--text-primary)]"
                >
                  <option value="">
              ...
              <div className="w-20">
                <input
                  ...
                  min="1"
                  className="w-full px-3 py-2 rounded-xl glass-input text-[color:var(--text-main)] text-[color:var(--text-primary)] text-center"
                />
              </div>
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full glass-btn text-[color:var(--text-main)] text-[color:var(--text-primary)] py-4 rounded-xl font-semibold flex items-center justify-center"
      >
