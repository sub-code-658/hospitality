    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          >
            {t("common.sign_in_to_your_account", "Sign in to your account")}
          </p>
        </div>
        ...
        <div className="panel p-8 animate-slide-up">
          ...
          >
            ...
            >
              {t(
                "common.quick_fill_test_credentials",
            ...
            <div className="flex gap-3">
              {["organizer", "worker"].map((type) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.borderColor = "rgba(232,104,30,0.35)";
                    e.currentTarget.style.color = "#111827";
                  }}
                  onMouseLeave={(e) => {
          ...
          >
            ...
            >
              {t("common.register_here", "Register here")}
            </Link>
          </p>
        </div>
      </div>
