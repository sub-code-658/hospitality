      ...
      <div className="flex items-center justify-between mb-8 animate-slide-up">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="glass px-4 py-2 rounded-xl text-[color:var(--text-main)] text-[color:var(--text-primary)] hover:bg-[color:var(--surface-raised)] transition-all"
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-sm font-medium capitalize transition-all duration-300 ${
              filter === f
                ...
                : "glass text-[color:var(--text-main)]/60 text-[color:var(--text-primary)]/60 hover:text-white"
            }`}
          >
            {f}
          </button>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p
                      className={`text-[color:var(--text-main)] text-[color:var(--text-primary)] ${!notification.isRead ? "font-medium" : ""}`}
                    >
                      {notification.content}
                    </p>
                    <p className="text-[color:var(--text-main)]/40 text-[color:var(--text-primary)]/40 text-sm mt-1">
                      {notification.time ||
                ...
                <div className="flex gap-2">
                  {!notification.isRead && (
                    <button
                      ...
                      className="text-[color:var(--text-main)]/50 text-[color:var(--text-primary)]/50 hover:text-white text-sm"
                      title="Mark as read"
                    >
                      ✓
                    </button>
                  ...
                  <button
                    ...
                    className="text-[color:var(--text-main)]/50 text-[color:var(--text-primary)]/50 hover:text-red-400 text-sm"
                    title="Delete"
                  >
                    ✕
                  </button>
