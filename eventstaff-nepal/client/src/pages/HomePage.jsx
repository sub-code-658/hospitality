...
export default function HomePage() {
  ...
  const upcoming = featuredEvents.filter(
    (e) => getEventState(e) === "Upcoming",
  );
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 60% at 0% 30%, rgba(232,104,30,0.06) 0%, transparent 70%)",
          }}
        />

        <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 py-32 w-full">
          <div className="animate-fade-in">
            <p className="label mb-8 tracking-[0.3em]">
              {t("home.label_premier")}
            </p>
            ...
            >
              {!user ? (
                <>
                  <Link to="/register" className="btn-glass px-8 py-3.5">
                    {t("nav.register")}
                  </Link>
                  <Link to="/events" className="btn-glass px-8 py-3.5">
                    {t("nav.events")}
                  </Link>
                </>
              ) : user.role === "organizer" ? (
                <>
                  <Link to="/dashboard" className="btn-glass px-8 py-3.5">
                    {t("nav.dashboard")}
                  </Link>
                  <Link to="/events" className="btn-glass px-8 py-3.5">
                    {t("nav.events")}
        ...
        >
          ...
          >
            {t(
              "common.eventstaff_nepal_est_2024",
          ...
          {eventsLoading ? (
            ...
            <div className="card p-8 text-center">
              <p className="text-sm mb-4" style={{ color: "var(--text-dim)" }}>
                {t("common.failed_to_load_events", "Failed to load events")}
              </p>
              <button
                    ...
                    {ongoing.map((event) => (
                      ...
                      >
                        ...
                        >
                          ...
                          <span>·</span>
                          <span>
                            {event.acceptedCount ?? 0}/{event.totalPositions}{" "}
                            staff
                          </span>
                        </div>
                      </Link>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {!user ? (
              <>
                <Link to="/register" className="btn-glass px-10 py-3.5">
                  {t("nav.register")}
                </Link>
                <Link to="/login" className="btn-glass px-10 py-3.5">
                  {t("nav.login")}
                </Link>
              </>
            ) : (
              <Link
                ...
                className="btn-glass px-10 py-3.5"
              >
                {user.role === "organizer"
                  ? t("home.view_my_events")
                  : t("home.find_work")}
              </Link>
            )}
          </div>
